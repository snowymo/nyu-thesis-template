...
\newcommand{\thesistitle}{Enhancing Collaboration and Productivity in Virtual and Augmented Reality}
\newcommand{\thesisauthor}{Zhenyi He}
\newcommand{\thesisadvisor}{Ken Perlin}
\newcommand{\thesisdept}{Computer Science}
\newcommand{\gradmonth}{January}
\newcommand{\gradyear}{2021}
%% If you do not want a dedication, scroll down and comment out
%% the appropriate lines in this file.
\newcommand{\thesisdedication}{To my parents, with affection.}
